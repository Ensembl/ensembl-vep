...
) ENGINE=MyISAM AUTO_INCREMENT=56670279 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=61417113 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=73739 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=111725760 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation_feature` (
  ...
  KEY `consequence_type_idx` (`consequence_types`),
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=110564058 DEFAULT CHARSET=latin1;
