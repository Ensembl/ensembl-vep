...
) ENGINE=MyISAM AUTO_INCREMENT=50793 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=303714 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=26678148 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=32288626 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=10423977 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=34389350 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=432161 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_exon` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=360133 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=51548 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10047574 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5371660 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=608950 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=16887475 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=2006292491 DEFAULT CHARSET=latin1;
...
CREATE TABLE `seq_region_synonym` (
  ...
  KEY `seq_region_idx` (`seq_region_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3588 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=197376 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=11366612 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=838308 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=13086001 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=9462317 DEFAULT CHARSET=latin1;
