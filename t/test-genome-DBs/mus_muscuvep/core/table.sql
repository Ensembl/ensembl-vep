...
) ENGINE=MyISAM AUTO_INCREMENT=50839 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=1884 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8615304 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5205430 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=100467 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=2640680 DEFAULT CHARSET=latin1;
