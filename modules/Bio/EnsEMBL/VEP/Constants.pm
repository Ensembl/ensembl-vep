...
our @FLAG_FIELDS = (
  ...
  { flag => 'af_gnomad',       fields => ['gnomAD-v2_AF','gnomAD-v2_AFR_AF','gnomAD-v2_AMR_AF','gnomAD-v2_ASJ_AF','gnomAD-v2_EAS_AF','gnomAD-v2_FIN_AF','gnomAD-v2_NFE_AF','gnomAD-v2_OTH_AF','gnomAD-v2_SAS_AF'] },
  { flag => 'af_gnomad_v3',    fields => ['gnomAD-v3_AF','gnomAD-v3_AFR_AF', ,'gnomAD-v3_AMI_AF', 'gnomAD-v3_AMR_AF','gnomAD-v3_ASJ_AF','gnomAD-v3_EAS_AF','gnomAD-v3_FIN_AF','gnomAD-v3_MID_AF','gnomAD-v3_NFE_AF','gnomAD-v3_OTH_AF','gnomAD-v3_SAS_AF'] },
...
our %FIELD_DESCRIPTIONS = (
  ...
  'gnomAD-v2_AF',         => 'Frequency of existing variant in gnomAD exomes combined population',
  'gnomAD-v2_AFR_AF',     => 'Frequency of existing variant in gnomAD exomes African/American population',
  'gnomAD-v2_AMR_AF',     => 'Frequency of existing variant in gnomAD exomes American population',
  'gnomAD-v2_ASJ_AF',     => 'Frequency of existing variant in gnomAD exomes Ashkenazi Jewish population',
  'gnomAD-v2_EAS_AF',     => 'Frequency of existing variant in gnomAD exomes East Asian population',
  'gnomAD-v2_FIN_AF',     => 'Frequency of existing variant in gnomAD exomes Finnish population',
  'gnomAD-v2_NFE_AF',     => 'Frequency of existing variant in gnomAD exomes Non-Finnish European population',
  'gnomAD-v2_OTH_AF',     => 'Frequency of existing variant in gnomAD exomes other combined populations',
  'gnomAD-v2_SAS_AF',     => 'Frequency of existing variant in gnomAD exomes South Asian population',
  'gnomAD-v3_AF',         => 'Frequency of existing variant in gnomAD genomes combined population',
  'gnomAD-v3_AFR_AF',     => 'Frequency of existing variant in gnomAD genomes African/American population',
  'gnomAD-v3_AMI_AF',     => 'Frequency of existing variant in gnomAD genomes Amish population',
  'gnomAD-v3_AMR_AF',     => 'Frequency of existing variant in gnomAD genomes American population',
  'gnomAD-v3_ASJ_AF',     => 'Frequency of existing variant in gnomAD genomes Ashkenazi Jewish population',
  'gnomAD-v3_EAS_AF',     => 'Frequency of existing variant in gnomAD genomes East Asian population',
  'gnomAD-v3_FIN_AF',     => 'Frequency of existing variant in gnomAD genomes Finnish population',
  'gnomAD-v3_MID_AF',     => 'Frequency of existing variant in gnomAD genomes Mid-eastern population',
  'gnomAD-v3_NFE_AF',     => 'Frequency of existing variant in gnomAD genomes Non-Finnish European population',
  'gnomAD-v3_OTH_AF',     => 'Frequency of existing variant in gnomAD genomes other combined populations',
  'gnomAD-v3_SAS_AF',     => 'Frequency of existing variant in gnomAD genomes South Asian population',
