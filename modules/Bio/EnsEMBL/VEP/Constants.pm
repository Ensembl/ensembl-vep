...
our @FLAG_FIELDS = (
  ...
  { flag => 'af_gnomad',       fields => ['gnomAD_AF','gnomAD_AFR_AF','gnomAD_AMR_AF','gnomAD_ASJ_AF','gnomAD_EAS_AF','gnomAD_FIN_AF','gnomAD_NFE_AF','gnomAD_OTH_AF','gnomAD_SAS_AF','gnomAD_afr_AF','gnomAD_amr_AF','gnomAD_asj_AF','gnomAD_eas_AF','gnomAD_fin_AF','gnomAD_nfe_AF','gnomAD_oth_AF','gnomAD_sas_AF'] },
...
our %FIELD_DESCRIPTIONS = (
  ...
  'gnomAD_afr_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes African/American population',
  'gnomAD_amr_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes American population',
  'gnomAD_asj_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes Ashkenazi Jewish population',
  'gnomAD_eas_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes East Asian population',
  'gnomAD_fin_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes Finnish population',
  'gnomAD_nfe_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes Non-Finnish European population',
  'gnomAD_oth_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes other combined populations',
  'gnomAD_sas_AF',     => 'Frequency of existing variant in gnomAD r2.1 exomes South Asian population',
